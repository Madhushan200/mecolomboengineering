          ...
          filteredWorkOrders.map(wo => {
            ...
            return (
              ...
              >
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {wo.afterPhotoUrl && (
                      <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 border border-emerald-200">
                        <CheckCircle2 className="w-3 h-3" /> Repair Proof
                      </span>
                    )}
                ...
                {/* Problem Title, Details & Photo Thumbnails */}
                <div className="flex items-start justify-between gap-4">
                  ...
                  {wo.photoUrl && (
                    <div
                      ...
                      className="w-14 h-14 rounded-lg overflow-hidden border border-slate-200 shrink-0 bg-slate-100 cursor-pointer hover:opacity-90 shadow-xs relative group"
                      title="Click to view work order & photo"
                    >
